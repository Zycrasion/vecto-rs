...
vec4_test_f64!(addition_test_f64, +);
vec4_test_f64!(subtraction_test_f64, -);
vec4_test_f64!(multiplication_test_f64, *);
vec4_test_f64!(division_test_f64, /);
...
fn normalized()
{
    ...
    assert_eq!(a.normalized(), Vector4 { x: 0.6401843996644799, y: 0.7682212795973759, z: 0.0, w: 0.0 });
    assert_eq!(b.normalized(), Vector4 { x: 0.7071067811865475, y: -0.7071067811865475, z: 0.0, w: 0.0 });
}   
